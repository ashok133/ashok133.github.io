function initMap() {
        ...
        var myLatlng = new google.maps.LatLng(39.17,-86.49);

        var map = new google.maps.Map(document.getElementById('googlemapbg'), {
          center: myLatlng,
          zoom: 5,
		...
		if(document.getElementsByTagName('title')[0].innerHTML == "About - Ashok Patel") {
			markerFileUrl = "";
		}
